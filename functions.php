...
function hackeryou_styles(){
	...
	wp_enqueue_style('googlefonts', 'https://fonts.googleapis.com/css?family=Oswald:400,700,300|Old+Standard+TT:400,700');
}
...
function hackeryou_continue_reading_link() {
	return '<div><a class="more-link" href="'. get_permalink() . '">Read More</a></div>';
}
